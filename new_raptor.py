...
/***************************************************************************
 ...
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
        ...
        begin                : 2023-12-03
        git sha              : $Format:%H$
        copyright            : (C) 2023 by Maria Martinez
...
class NewRaptor:
    ...
    def run(self):
        ...
        if result:
            ...
            QMessageBox.information(self.dlg, "Message","New NestID: {}\n\nLatitude:{}\nLogitude:{}\nSpecies: {}\nStatus:{}\nLastSurvey: {}".format(valNestID,valLat,valLng,valSpecies,valStatus,valLast))
            ...
            for linear in linears:
                ...
                if valDistance < valBuffer:
                    row=dlgTable.tableWidget.rowCount()
                    dlgTable.tableWidget.insertRow(row)
                    dlgTable.tableWidget.setItem(row, 0, QTableWidgetItem(str(valID)))
                    dlgTable.tableWidget.setItem(row, 1, QTableWidgetItem(str(valType)))
                    twi= QTableWidgetItem(str("{:4.5f}".format(valDistance)))
                    twi.setTextAlignment(QtCore.Qt.AlignRight)
                    dlgTable.tableWidget.setItem(row, 2, twi)
                    
            dlgTable.tableWidget.sortItems(2)
            dlgTable.show()
            dlgTable.exec_()
